...
if (appointmentForm) {
    appointmentForm.addEventListener('submit', function(e) {
        ...
        const existing = JSON.parse(localStorage.getItem('nova_denta_appointments') || '[]');
        existing.push(data);
        localStorage.setItem('nova_denta_appointments', JSON.stringify(existing));
    ...
    function renderRegistrationTable() {
        ...
        const items = JSON.parse(localStorage.getItem('nova_denta_appointments') || '[]');
        tableBody.innerHTML = '';
...
const serviceDetailsMap = {
    'general': {
        ...
        description: 'Bonus tekshiruvlar, profilaktika, tish tozalash va yoriqlarni davolash.',
    ...
    'cosmetic': {
        ...
        description: 'Oqartirish, vinirlar, bo\'shliqlarni to\'g\'rilash va estetik dizayn.',
